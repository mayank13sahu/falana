...
export default function Homes() {
  ...
  return (
    <div>
     ...
     <div> <div id="carouselExampleFade"
        className="carousel slide carousel-fade " data-bs-ride="carousel" style={{objectFit:"contain !important"}}
      >
        <div className="carousel-inner " id="carousel">
          ...
          <div className="carousel-item active">
            <img
              src="https://source.unsplash.com/random/600x700/?pizza"
          ...
          <div className="carousel-item">
            <img
              src="https://source.unsplash.com/random/600x700/?pastry"
              className="d-block w-100 "
          ...
          <div className="carousel-item">
            <img
              src="https://source.unsplash.com/random/600x700/?noodles"
              className="d-block w-100 "
              style={{ filter: "brightness(30%)" }}
              alt="..."
            />
